...
import { Badge, Card, EmptyState, Progress, Stat , PageHeader } from '@/components/ui';
...
export default async function SprintsPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader title="Weekly Sprints" subtitle={<>Every week is preserved. Closed weeks keep a frozen scorecard.</>} />
        ...
        sprints.map((sprint) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-1 border-t border-hairline px-4 py-2 text-xs text-ink-500">
